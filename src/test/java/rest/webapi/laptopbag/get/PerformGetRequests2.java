...
public class PerformGetRequests2 {
	...
	/*
	 * When I perform GET Request to ping method without an argument Then status
	 * code should be 404
	 */
	@Test
	...
	/*
	 * Scenario: All method Given Accept content is Json When I perform GET
	 * request to all api method Then status code should be 200 And Body should
	 * contain Laptop details in JSON
	 */
	...
	/*
	 * Scenario: Get laptop infromation by using find method and id Given Accept
	 * type is JSON When I perform GET request to find method with id 150 Then
	 * Status code should be 200 And ID should be 150 And BrandName is Dell
	 */
	@Test
	public void testFindWithID() throws URISyntaxException {
		...
		given().accept(ContentType.JSON).when().get(findURI).then().assertThat().statusCode(200).and().assertThat()
				.body("Id", equalTo(150)).and().assertThat().body("BrandName", equalToIgnoringCase("hp"));

		given().accept(ContentType.JSON).when().get(findURI).then().assertThat().statusCode(200).and().assertThat()
				.body("Id", equalTo(150), "BrandName", equalToIgnoringCase("hp"));

	}

	/*
	 * Scenario: Features list content Given accept type is JSON When I perform
	 * GET request with id 150 Then status code should be 200 And Features
	 * should be 3 items And Features should contain following: "16GB RAM",
	 * "500GB SSD", "i7 CPU"
	 */
